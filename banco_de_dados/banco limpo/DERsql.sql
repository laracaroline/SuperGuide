...
CREATE TABLE IF NOT EXISTS `mydb`.`ESTADOS` (
  ...
  INDEX `fk_ESTADOS_PAISES1_idx` (`id_pais` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`CIDADES` (
  ...
  INDEX `fk_CIDADES_ESTADOS1_idx` (`id_estado` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`SUPERMERCADOS` (
  ...
  `foto_supermercado` VARCHAR(500) NULL,
  `id_cidade` INT NOT NULL,
  PRIMARY KEY (`id_supermercado`),
  INDEX `fk_SUPERMERCADOS_CIDADES1_idx` (`id_cidade` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`CATEGORIAS` (
  ...
  `foto_categoria` VARCHAR(500) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`PRODUTOS` (
  ...
  `foto_produto` VARCHAR(500) NULL,
  `id_marca` INT NOT NULL,
  `id_categoria` INT NOT NULL,
  PRIMARY KEY (`id_produto`),
  INDEX `fk_PRODUTOS_MARCAS1_idx` (`id_marca` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`PRECO_PRODUTOS` (
  ...
  INDEX `fk_PRODUTOS_has_SUPERMERCADOS_SUPERMERCADOS1_idx` (`id_supermercado` ASC) VISIBLE,
  INDEX `fk_PRODUTOS_has_SUPERMERCADOS_PRODUTOS1_idx` (`id_produto` ASC) VISIBLE,
