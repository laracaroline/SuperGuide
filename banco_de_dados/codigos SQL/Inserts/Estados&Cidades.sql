...
INSERT INTO `paises` (`id_pais`, `nome_pais`) VALUES (1, 'Brasil');
...
CREATE TABLE IF NOT EXISTS `estados` (
  ...
  KEY `fk_Estados_paises` (`id_pais`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=28 ;


INSERT INTO `estados` (`id_estado`, `nome_estado`, `id_pais`) VALUES
(1, 'Acre', 1),
(2, 'Alagoas', 1),
(3, 'Amazonas', 1),
(4, 'Amapá', 1),
