...
<html>
	...
	<link rel="stylesheet" type="text/css" href="../HTML/src/semantic.min.css">
	<script
  src="https://code.jquery.com/jquery-3.1.1.min.js"
  integrity="sha256-hVVnYaiADRTO2PzUGmuLJr8BLUSjGIZsDYGmIJLv2b8="
  crossorigin="anonymous"></script>
	<script src="../HTML/src/semantic.min.js"></script>

	<link rel="stylesheet" type="text/css" href="../HTML/src/css/style_login.css">
	...
	<script type="text/javascript" src="../HTML/src/js/script_index.js"></script>
