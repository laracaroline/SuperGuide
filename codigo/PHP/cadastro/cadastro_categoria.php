...
<html>
  <head>
    ...
    crossorigin="anonymous"></script>
  	...
  	<script type="text/javascript" src="../../HTML/src/js/script_categorias.js"></script>
    ...
    <div class="container">
      <div class="container">
        <div class="form_cadastro">
          <form id="login_form" method="POST" action="inserir_categoria.php">
          <h2>Cadastro de categoria</h2></br></br>
